    ...
    <Screen isProject={true} isMobile={isMobile}>
      ...
      <Section
        ...
        content={[
          ...
          {
            imageGIF: "marikone-basic-wireframes",
            style: "end",
          },
        ]}
      />
        ...
        content={[
          {
            ...
            text: "For a portfolio website, it's essential to immediately let the people know what kind of website are they visiting. I choose to keep it simple and do it with a minimalist title and make users interested by showing Marikone's latest collections. The collection section will always be updated with her recent work and people will be able to browse what kind of clothes Marikone creates.",
          },
          {
